...
package com.example.heesue.contextawaretest;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String TAG = "CONTEXT_AWARE";
...
//                                    Log.i(TAG, p.getPlace().getName().toString() + " : " + p.getLikelihood());
//                                }
//                            } else {
...
//        Log.i(TAG, "Current Time: " + current_time);
